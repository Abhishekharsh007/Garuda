...
5. **Problem**: Send data reliably and fairly without errors. Solution: A set of rules (TCP/IP) to break data into small, add5. ressed **packets** that can be reassembled.
...
1. Th1. e Authoritative Server sends the IP address back to the Recursive Resolver.
...
- Look at the img.png for more clarity.